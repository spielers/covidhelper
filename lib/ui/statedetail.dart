            ...
            child: Padding(
              ...
              child: Column(
                children: <Widget>[
                  ...
                  Row(
                    children: <Widget>[
                      colorCard("Confirmed IN", corona.district, context,
                          Color(0xFF8fb9a8)),
                      colorCard("Confirmed FN", corona.confirmed, context,
                          Color(0xFFf1828d)),
                    ],
                  ),
                  Row(
                    children: <Widget>[
                      colorCard("Discharged", corona.confirmed, context,
                          Color(0xFF765d69)),
                      colorCard(
                          "Death", corona.confirmed, context, Color(0xFF685d79)),
                    ],
                  ),
                ],
              ),
